...
Here's the kicker: network partitions _will_ happen. Cables get cut. Data centers go dark. Packets get lost in the void. So in practice, you're really choosing between **consistency** and **availability** when things go wrong.
