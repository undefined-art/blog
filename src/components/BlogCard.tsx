  ...
  return (
    <article className="card-hover group">
      <Link
        ...
        className="block p-6 -m-6 rounded-2xl hover:bg-parchment-100/50 dark:hover:bg-ink-900/50 transition-colors duration-300"
      ...
      >
        ...
        <div className="mt-4 flex items-center gap-2 text-accent-terracotta dark:text-accent-ochre font-medium text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-200">
