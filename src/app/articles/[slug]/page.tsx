  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-16 md:py-24">
      <ArticlePageMotion>
        <Link
          href="/articles/"
          className="inline-flex items-center gap-2 text-ink-500 dark:text-ink-400 hover:text-accent-terracotta dark:hover:text-accent-ochre transition-colors duration-200 mb-8"
        ...
        <article>
          <header className="mb-12">
            ...
            <p className="mt-4 text-lg text-ink-600 dark:text-parchment-400">{post.description}</p>
            ...
            {post.image && (
              <div className="mt-8 relative w-full aspect-video overflow-hidden rounded-xl">
                <Image
