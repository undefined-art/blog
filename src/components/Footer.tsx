...
export const Footer = () => {
  ...
  return (
    <footer className="border-t border-ink-100 dark:border-ink-800 bg-parchment-100/50 dark:bg-ink-900/50">
      <div className="max-w-4xl mx-auto px-6 py-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-center md:text-left">
            <Link
              href="/"
              className="font-display text-xl font-semibold text-ink-800 dark:text-parchment-200"
          ...
          <div className="flex items-center gap-6">
            <a
              ...
              className="text-ink-500 dark:text-ink-400 hover:text-accent-terracotta dark:hover:text-accent-ochre transition-colors duration-200"
